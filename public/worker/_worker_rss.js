export default function generateRSS(key) {
    const rssMap = {
        "/news": {
            title: "新闻资讯",
            description: "新闻资讯",
            logo: require('@/assets/logos/tgmeng-trend_tencent.png'),
            children: {
                "/news/baidu": {title: "腾讯", description: "腾讯", logo: require('@/assets/logos/tgmeng-trend_tencent.png'), link: "https://trendapi.tgmeng.com/topsearch/baidu"},
                "/news/toutiao": {title: "头条", description: "头条", logo: require('@/assets/logos/tgmeng-trend_toutiao.png'), link: "https://trendapi.tgmeng.com/topsearch/toutiao"}
            }
        },
        "/media": {
            title: "媒体资讯",
            ...
            children: {
                "/media/bilibili": {title: "B站", description: "B站", logo: require('@/assets/logos/tgmeng-trend_bilibili.png'), link: "https://trendapi.tgmeng.com/topsearch/bilibili"},
                "/media/douyin": {title: "抖音", description: "抖音", logo: require('@/assets/logos/tgmeng-trend_douyin.png'), link: "https://trendapi.tgmeng.com/topsearch/douyin"}
            }
        }
    };
